...
const LANGUAGE = {
	chs: {
		...
		application: {
			...
			haggleShareTitle: '我发现了好货,快来帮我砍价',
			bargaiDetailShareTitle: '好物一起砍，省钱又开心',
			joinBuyShareTitle: '邀请您参与拼团',
			joinBuyDetailShareTitle: '这里有好货，一起拼团吧',
			discountShareTitle: '限时折扣活动进行中，速来围观',
			limitedShareTitle: '分享给你一个团购秒杀产品，速抢',
		...
		profile: {
			...
			totalCommission: '累计{0}',
			leftCommission: '可用{0}',
			frozenCommission: '未结算{0}',
			outCommission: '已提现',
			frozenCommissionTip: '未结算{0}是指未结算、未到账、提现中(未到账)、或其它情况下的未入账部分。',
			myFootprint: '我的足迹',
			goShopping: '先去逛逛~',
			tools: '常用功能',
			recharge: '充值',
		...
		product: {
			...
			marketingLimitedBuy: '限量购',
			marketingLimitedBuyInfo: '起购:{0}件,限购:{1}件',
			marketingJoinBuy: '拼团',
			marketingJoinBuyNum: '{0}人团',
			marketingJoinBuySuccess: '成功拼团{0}次',
			marketingJoinBuyValidTime: '{0}小时内满人成团',
			joinBuyRuleTitle: '拼团规则',
			joinBuyRuleInfo: '拼团玩法介绍',
			joinBuyRuleStep1: '团长开团',
			joinBuyRuleStep2: '邀请好友',
			joinBuyRuleStep3: '拼团成功',
			joinBuyRuleStep4: '等待发货',
			joinBuyLack: '还差{0}人成团',
			joinBuyJoinTitle: '{0}人正在拼团，可直接参与',
			joinBuyJoinInfo: '查看全部',
			joinBuyJoin: '去参团',
			joinBuyRuleModelTitle: '拼团玩法',
			joinBuyRuleModelInfo: [
			...
			maxBuy: '限购',
			maxBuyPertime: '最多购买{0}',
			overMoneyShippingFree: '满{0}包邮',
			overPointShipping: '购买赠送{0}{1}',
			overReduce: '满减',
			getPointsAfterOrder: '下单后最低可获得{0}{1}',
			needPoint: '需用{0}',
			needPointInfo: '同时需使用{0}{1}才能购买',
			needPointTip: '需{0}{1}',
			deduct: '{0}抵扣',
			deductByPoints: '每件商品最多可使用{0}{1}抵扣{2}元',
			deductByPointsTip: '可用{0}{1}',
			exchange: '换购',
			exchangeByPoints: '{0}换购',
			exchangeByPointsTip: '可使用{0}{1}换购商品',
			preferential: '优惠',
		...
		// 砍价部分
		haggle: {
			haggleIndexTitle: '砍价活动',
			haggleListTitle: '砍价列表',
			haggleProduct: '砍价商品',
			startSoon: '活动即将开始',
			progress: '活动进行中',
			alreadyOver: '活动已结束',
			...
			joinNumber: '{0}人参与砍价',
			myBargain: '我的砍价',
			haggleSuccess: '还差{0}元就成功了',
			haggleerror: '砍价失败',
			haggleStatusSuccess: '砍价成功',
			haggles: '继续砍价',
			haggleReload: '再砍一个',
			bargaiInvalid: '拼团失效',
			...
			haggleDetailTip1: '看见砍价,随手一砍',
			haggleDetailTip2: '分享给好友,还能砍更多',
			haggleDetailTip3: '再接再厉,很快砍成功',
			haggleDetailTip4: '拔刀相助,在所不辞',
			haggleDetailTip5: '我已经使出洪荒之力',
			haggleDetailTip6: '感情深,刀法稳',
			haggleDetailTip7: '看我的一阳指,过来就是一刀',
			haggleShare: '复制分享链接成功',
			haggleEmpty: '暂无砍价记录',
		},
		// 地址
		address: {
		...
		joinBuy: {
			joinBuyTitle: '拼团',
			joinBuyShare: '为您推荐了一个拼团商品，多人拼购更便宜',
			toJoinBuy: '去开团',
			yesGroup: '人团',
			groupPrice: '拼到价值{0}元的 ',
		},
		joinBuyGroup: {
			joinBuyGroupTitle: '我的拼团',
			joinBuyLeftTime: '距结束还剩',
			joinBuyStart: '开团',
			joinBuyShareTip: '还差{0}人成团,去分享吧',
			joinBuyOutOfTime: '开团超时',
			joinBuyPay: '等待支付',
			joinBuySuccess: '已成团',
			joinBuyFail: '开团失败',
			joinBuyOrderTip: '共1件商品,总金额',
			joinBuyButtonPay: '去支付',
			joinBuyButtonShare: '邀请好友',
			joinBuyButtonDetail: '拼团详情',
			joinBuyButtonOrderDetail: '订单详情',
			joinBuyEmpty: '暂无拼团订单',
			joinBuyStatusAll: '全部',
			joinBuyStatusProgress: '拼团中',
			joinBuyStatusSuccess: '拼团成功',
			joinBuyStatusFail: '拼团失败',
		},
		joinBuyDetail: {
			joinBuyDetailTitle: '拼团详情',
			joinBuyDetailShare: '邀请您参与拼团',
			joinBuyNum: '{0}人团',
		},
		//团购
		limited: {
			limitedTitle: '限量购',
			limitedShare: '分享给你一个限量购产品，速抢',
		...
		distribution: {
			...
			amountOfCommissionAvailableForWithdrawal: '可提现{0}金额',
			theDetail: '明细',
