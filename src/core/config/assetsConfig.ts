...
export default {
	...
	// //拼团图标
	// iconJoinBuy: PATH + '/icon-wholesale.png',
	// //砍价图标
	// iconBargain: PATH + '/icon-haggle.png',
	// //限时折扣图标
	...
	//拼团图标
	iconJoinBuy: PATH + '/icon-join-buy.png',
	//砍价图标
	iconHaggle: PATH + '/icon-haggle.png',
	//限时折扣图标
	iconDiscount: PATH + '/icon-discount.png',
	//限量购图标
	iconLimitedBuy: PATH + '/icon-limited-buy.png',
	...
	// 拼团标签
	joinBuyTag: PATH + '/join-buy-tag.png',
	// 团购标签
	limitedBuyTag: PATH + '/limited-buy-tag.png',
	// 砍价标签
	haggleTag: PATH + '/haggle-tag.png',
	// 折扣标签
	...
	//拼团
	joinBuyStep1: PATH + '/join-buy-step-1.png',
	joinBuyStep2: PATH + '/join-buy-step-2.png',
	joinBuyStep3: PATH + '/join-buy-step-3.png',
	joinBuyStep4: PATH + '/join-buy-step-4.png',
	// 会员等级图标
	...
	// 会员中心
	// 专属客服
	memberLevelCustomerService: PATH + 'member-level-customer-service.png',
	// 专享优惠劵
	memberLevelCoupon: PATH + 'member-level-coupon.png',
	// 会员折上折
	memberLevelDiscount: PATH + 'member-level-discount.png',
	// 会员商品
	memberLevelProduct: PATH + 'member-level-product.png',

	// 积分大转盘
	// 背景图片
	luckyWheelBg: PATH + 'lucky_wheel_bg.png',

	luckyWheelButton: PATH + 'lucky_wheel_button.png',

	luckyWheelTriangle: PATH + 'lucky_wheel_triangle.png',
	// 实体店中奖背景
	storeWeelWinBg: PATH + 'store_wheel_win_bg.png',

	// 推荐有礼
	couponPic: PATH + 'coupon_pic.png',
	integralPic: PATH + 'integral_pic.png',
	moneyPic: PATH + 'money_pic.png',
	posterPic: PATH + 'poster_pic.png',
