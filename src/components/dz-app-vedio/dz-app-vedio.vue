<template>
  <view class="dz-video-h5-view-box">
    <!--封面-->
    <view class="video-cover-view" v-if="coverShow">
      <view
        class="bg-img bg-mask flex align-center text-center video-cover"
        :style="[{ backgroundImage: 'url(' + vedioCover + ')' }]"
      >
      ...
      <view
        class="video-click"
        @click="video_view.onClick"
        :data-index="vedioIndex"
        :data-src="vedioUrl"
      ></view>
    </view>
    ...
    <view
      ref="videoRef"
      class="dz-video-h5-box"
      :id="['video_h5_' + vedioIndex]"
    ></view>
  </view>
</template>
