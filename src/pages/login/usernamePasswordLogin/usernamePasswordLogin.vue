		...
		<view class="container">
			...
			<view class="form-wrap">
				<view class="dz-m-t-60">
					...
					>
						<template #prefix>
							<view class="dz-m-r-15 dz-main-color" style="width: 100rpx">用户名</view>
						</template>
					</dz-input>
				</view>
				<view class="dz-m-t-30">
					...
					>
						<template #prefix>
							<view class="dz-m-r-15 dz-main-color" style="width: 100rpx">密码</view>
						</template>
						<template #suffix>
				...
				<view class="dz-text-right dz-p-20 dz-font-24 dz-tips-color" @tap="handelUsernameMobileRegister()">立即注册</view>
			...
			<view
				v-if="passwordLogin || isMobileLogin || (showAppleLogin && appAppleLogin) || showWechatLogin"
...
function handelUsernameMobileRegister() {
	uni.$api.router.push({
...
async function handleSubmit() {
	...
	await uni.$api.http
		.post(uni.$api.apiMember.usernamePasswordLogin, {
			...formData,
		})
		.then((res) => {
